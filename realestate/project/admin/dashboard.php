...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <p>Pronat e listuara</p>
      <a href="listings.php" class="btn">Shiko listimin</a>
   </div>
   ...
   <div class="box">
      ...
      ?>
      <h3><?= $count_users; ?></h3>
      <p>Përdoruesit total</p>
      <a href="users.php" class="btn">Perdoruesit</a>
   </div>
   ...
   <div class="box">
      ...
      <h3><?= $count_admins; ?></h3>
      <p>Adminat total</p>
      <a href="admins.php" class="btn">Adminat</a>
   </div>
   ...
   <div class="box">
      ...
      <p>Mesazhet e reja</p>
      <a href="messages.php" class="btn">Mesazhet</a>
   </div>
