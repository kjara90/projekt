...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Prona u fshi!';
   }else{
      $warning_msg[] = 'Prona është e fshirë!';
   }
...
<section class="listings">
   ...
   <h1 class="heading">Listimet </h1>

   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="Kërko pronat..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <p class="price">All </i><?= $fetch_listing['price']; ?></p>
      ...
      <form action="" method="POST">
         ...
         <a href="view_property.php?get_id=<?= $listing_id; ?>" class="btn">Prona</a>
         <input type="submit" value="Fshi " onclick="return confirm('delete this listing?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
         }
      }elseif(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
         echo '<p class="empty">Nuk u gjet asnjë pronë!</p>';
      }else{
         echo '<p class="empty">Nuk është postuar asnjë pronë akoma!</p>';
      }
   ?>
