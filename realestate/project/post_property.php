...
if(isset($_POST['post'])){
   ...
   if($image_01_size > 2000000){
      ...
      $success_msg[] = 'Prona u postua me sukses!';
   }
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <h3>Detajet e pronës</h3>
      <div class="box">
         <p>Emri i pronës <span>*</span></p>
         <input type="text" name="property_name" required maxlength="50" placeholder="vendos emrin e pronë" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>Cmimi i pronës <span>*</span></p>
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" placeholder="Vendos cmimin" class="input">
         </div>
         <div class="box">
            <p>Vlera e depozituar <span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder="Vendos vlerën e depozituar" class="input">
         </div>
         <div class="box">
            <p>Adresa <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="Vendosni adresën e plotë" class="input">
         </div>
         <div class="box">
            <p>Oferta <span>*</span></p>
         ...
         <div class="box">
            <p>Tipi i prones<span>*</span></p>
            <select name="type" required class="input">
               <option value="Apartament">Apartamenr</option>
               <option value="Vilë">Vilë</option>
               <option value="Dyqan">Dyqan</option>
            </select>
         </div>
         <div class="box">
            <p>Statusi i pronës <span>*</span></p>
            <select name="status" required class="input">
               <option value="Gati përshitje">Gati për shitje</option>
               <option value="Duke u ndërtuar">Duke u ndërtuar</option>
            </select>
         </div>
         <div class="box">
            <p>Statusi i mobilimit <span>*</span></p>
            <select name="furnished" required class="input">
               <option value="e mbiluar">e mobiluar</option>
         
               <option value="jo e mobiluar">jo e mobiluar</option>
            </select>
         </div>
         <div class="box">
            <p>Numri i dhomave <span>*</span></p>
            <select name="bhk" required class="input">
               ...
               <option value="6">6 dhoma</option>
               <option value="7">7 dhoma</option>
               <option value="8">8 dhoma</option>
               <option value="9">9 dhoma</option>
            </select>
         </div>
         <div class="box">
            <p>Dhoma gjumi <span>*</span></p>
         ...
         <div class="box">
            <p>Siperfaqja <span>*</span></p>
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="Siperfaqa?" class="input">
         </div>
         <div class="box">
            <p>Vjetërsia e pronës <span>*</span></p>
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="Vjetërsia e pronës?" class="input">
         </div>
         <div class="box">
            <p>Katet totale <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="Sa kate ka ndërtesa?" class="input">
         </div>
         <div class="box">
            <p>Kati <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="Kati në të cilën ndodhet" class="input">
         </div>
         <div class="box">
            <p>Kredi <span>*</span></p>
            <select name="loan" required class="input">
               <option value="available">Po</option>
               <option value="not available">Jo</option>
            </select>
         </div>
      </div>
      <div class="box">
         <p>Përshkrimi i pronës <span>*</span></p>
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="Përshkruaj..."></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
            <p><input type="checkbox" name="lift" value="yes" />Ashensor</p>
            <p><input type="checkbox" name="security_guard" value="yes" />Kamra sigurie</p>
            <p><input type="checkbox" name="play_ground" value="yes" />Sheshe</p>
            <p><input type="checkbox" name="garden" value="yes" />Kopesht</p>
            <p><input type="checkbox" name="water_supply" value="yes" />Palester</p>
            <p><input type="checkbox" name="power_backup" value="yes" />Gjenerator</p>
         </div>
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" />Parkim</p>
            <p><input type="checkbox" name="gym" value="yes" />Depozita</p>
            <p><input type="checkbox" name="shopping_mall" value="yes" />Qendër tregtare</p>
            <p><input type="checkbox" name="hospital" value="yes" />Spitale</p>
            <p><input type="checkbox" name="school" value="yes" />Shkolla</p>
            <p><input type="checkbox" name="market_area" value="yes" />Markete</p>
         </div>
      </div>
      <div class="box">
         <p>Imazhi 01 <span>*</span></p>
      ...
      <input type="submit" value="Posto pronën" class="btn" name="post">
   </form>
