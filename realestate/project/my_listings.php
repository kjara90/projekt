...
<section class="my-listings">
   ...
   <h1 class="heading">Listimet e mia</h1>
   ...
   <form accept="" method="POST" class="box">
      ...
      <div class="flex-btn">
         ...
         <input type="submit" name="delete" value="Fshi" class="btn" onclick="return confirm('delete this listing?');">
      </div>
      <a href="view_property.php?get_id=<?= $property_id; ?>" class="btn">Shikoni Pronat</a>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Asnje prone nuk eshte shtuar akoma! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
      }
      ?>
