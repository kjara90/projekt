...
if(isset($_POST['update'])){
   ...
   if(!empty($image_05)){
      if($image_05_size > 2000000){
         $warning_msg[] = 'Përmasat shumë të mëdha!';
      }else{
   ...
   $success_msg[] = 'Listim i sukseshëm!';
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <select name="type" required class="input">
               ...
               <option value="house">Vile</option>
