...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Mirserdhe sërisht!</h3>
      <input type="email" name="email" required maxlength="50" placeholder="Venndosni email-in" class="box">
      <input type="password" name="pass" required maxlength="20" placeholder="Vendosni password-in" class="box">
      <p>Nuk keni një account? <a href="register.html">Regjistrohu tani</a></p>
