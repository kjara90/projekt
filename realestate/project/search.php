...
<section class="filters" style="padding-bottom: 0;">
   ...
   <form action="" method="post">
      ...
      <h3>Filtro</h3>
         ...
         <div class="flex">
            <div class="box">
               <p>Vendos vendodhjen</p>
               <input type="text" name="location" required maxlength="50" placeholder="Vendos emrin e qytetit" class="input">
            </div>
            <div class="box">
               <p>Tipi i ofruar</p>
            ...
            <div class="box">
               ...
               <select name="status" class="input" required>
                  <option value="ready to move">Gati për tu shitur</option>
            ...
            <div class="box">
               ...
               <select name="furnished" class="input" required>
                  <option value="unfurnished">E mobiluar</option>
                  <option value="furnished">Jo e mobiluar</option>
                 
               </select>
            </div>
         </div>
         <input type="submit" value="Kërko pronën" name="filter_search" class="btn">
   </form>
...
<section class="listings">
   ...
   <?php 
      if(isset($_POST['h_search']) or isset($_POST['filter_search'])){
         echo '<h1 class="heading">Rezultatet e kërkimit</h1>';
      }else{
         echo '<h1 class="heading">Listimet e fundit</h1>';
      }
   ?>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price">All</i><span><?= $fetch_property['price']; ?></span></div>
            ...
            <div class="flex-btn">
               <a href="view_property.php?get_id=<?= $fetch_property['id']; ?>" class="btn">Shiko pronat</a>
      ...
      <?php
         ...
         echo '<p class="empty">Nuk u gjend asnjë rezultat!</p>';
      }
      ?>
