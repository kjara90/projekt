...
if(isset($_POST['submit'])){
   ...
   if($select_users->rowCount() > 0){
      $warning_msg[] = 'Email-i është i përdorur!';
   }else{
      if($pass != $c_pass){
         $warning_msg[] = 'Password nuk është i njëjtë!';
      }else{
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>Ju e keni një llogari? <a href="login.html">login </a></p>
